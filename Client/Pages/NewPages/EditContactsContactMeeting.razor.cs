...
{
    public partial class EditContactsContactMeeting
    {
        [Inject]
        ...
        {
            contactsContactMeeting = await EspoDbNewService.GetContactsContactMeetingByContactMeetingId(contactMeetingId:contact_meeting_id);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await EspoDbNewService.UpdateContactsContactMeeting(contactMeetingId:contact_meeting_id, contactsContactMeeting);
