...
{
    public partial class AddTargetTarget
    {
        [Inject]
        ...
        {
            targetTarget = new EspoNew.Server.Models.EspoDbNew.TargetTarget();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await EspoDbNewService.CreateTargetTarget(targetTarget);
