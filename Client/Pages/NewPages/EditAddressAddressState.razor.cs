...
{
    public partial class EditAddressAddressState
    {
        [Inject]
        ...
        {
            addressAddressState = await EspoDbNewService.GetAddressAddressStateByStateId(stateId:state_id);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await EspoDbNewService.UpdateAddressAddressState(stateId:state_id, addressAddressState);
