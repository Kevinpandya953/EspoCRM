...
{
    public partial class EditContactsContactDocument
    {
        [Inject]
        ...
        {
            contactsContactDocument = await EspoDbNewService.GetContactsContactDocumentByContactDocumentId(contactDocumentId:contact_document_id);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await EspoDbNewService.UpdateContactsContactDocument(contactDocumentId:contact_document_id, contactsContactDocument);
