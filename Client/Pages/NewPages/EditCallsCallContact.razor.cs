...
{
    public partial class EditCallsCallContact
    {
        [Inject]
        ...
        {
            callsCallContact = await EspoDbNewService.GetCallsCallContactByCallContactId(callContactId:call_contact_id);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await EspoDbNewService.UpdateCallsCallContact(callContactId:call_contact_id, callsCallContact);
