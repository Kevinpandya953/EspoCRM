...
{
    public partial class EditContactsContactOpportunity
    {
        [Inject]
        ...
        {
            contactsContactOpportunity = await EspoDbNewService.GetContactsContactOpportunityByContactOpportunityId(contactOpportunityId:contact_opportunity_id);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await EspoDbNewService.UpdateContactsContactOpportunity(contactOpportunityId:contact_opportunity_id, contactsContactOpportunity);
