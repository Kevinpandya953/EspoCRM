...
{
    public partial class AddTargetTargetList
    {
        [Inject]
        ...
        {
            targetTargetList = new EspoNew.Server.Models.EspoDbNew.TargetTargetList();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await EspoDbNewService.CreateTargetTargetList(targetTargetList);
