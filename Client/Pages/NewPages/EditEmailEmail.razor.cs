...
{
    public partial class EditEmailEmail
    {
        [Inject]
        ...
        {
            emailEmail = await EspoDbNewService.GetEmailEmailByEmailId(emailId:email_id);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await EspoDbNewService.UpdateEmailEmail(emailId:email_id, emailEmail);
