...
{
    public partial class EditCallsCallLead
    {
        [Inject]
        ...
        {
            callsCallLead = await EspoDbNewService.GetCallsCallLeadByCallLeadId(callLeadId:call_lead_id);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await EspoDbNewService.UpdateCallsCallLead(callLeadId:call_lead_id, callsCallLead);
