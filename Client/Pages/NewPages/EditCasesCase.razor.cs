...
{
    public partial class EditCasesCase
    {
        [Inject]
        ...
        {
            casesCase = await EspoDbNewService.GetCasesCaseByCaseId(caseId:case_id);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await EspoDbNewService.UpdateCasesCase(caseId:case_id, casesCase);
